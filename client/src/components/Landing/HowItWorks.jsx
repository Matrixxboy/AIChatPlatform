  ...
  const steps = [
    {
      ...
      desc: "Upon sign-in, select the language you are most comfortable with. The entire platform matches this setting automatically.",
      detail: "Switch or update anytime in your settings.",
      icon: Globe,
      iconColor: "text-blue-500 bg-blue-50 border-blue-100",
    },
    {
      step: "02",
      title: "Search & Add Your Contacts",
      desc: "To start chatting with anyone, simply search for their @username in your active dashboard search bar and send a connection request.",
      detail: "Connect securely with anyone worldwide.",
      icon: UserPlus,
      iconColor: "text-indigo-500 bg-indigo-50 border-indigo-100",
    },
    {
      step: "03",
      title: "Write Normally in Your Tongue",
      desc: "Type message boxes naturally. You never have to manually translate or use separate copy/paste tools.",
      detail: "Write as if they speak your language.",
      icon: MessageSquare,
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-20">
          ...
          <p className="text-slate-500 font-medium text-base">
            Initiate communication channels across multiple borders in a few
            clicks.
          </p>
        </div>
                ...
                <div className="w-full lg:w-1/2 flex justify-center px-0 lg:px-12">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="text-5xl font-black text-brand/10 font-display">
                        {stepObj.step}
                      </div>
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center border ${stepObj.iconColor}`}
                      >
                    ...
                    {idx === 0 && (
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="flex gap-2">
                          <span className="px-3 py-1 bg-slate-50 border border-slate-200 text-[10px] font-bold rounded-lg text-brand shadow-sm">
                            🇬🇧 English
                          </span>
                          <span className="px-3 py-1 bg-slate-50 border border-slate-200 text-[10px] font-bold rounded-lg text-slate-500 shadow-sm">
                            🇪🇸 Español
                          </span>
                          <span className="px-3 py-1 bg-slate-50 border border-slate-200 text-[10px] font-bold rounded-lg text-slate-500 shadow-sm">
                            🇮🇳 हिन्दी
