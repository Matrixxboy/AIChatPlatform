        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-slate-600 text-sm leading-relaxed font-semibold">
                Copying messages to external tabs, struggling to translate
                idioms, and losing momentum breaks client trust and team sync.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  title: "Exhaustive Copy-Pasting",
                  desc: "Leaving your active chat window constantly to copy text into Google Translate.",
                  icon: Copy,
                },
                {
                  title: "Slang & Context Errors",
                  desc: "Literal word-by-word systems fail to capture local idioms or technical vocabulary.",
                  icon: ShieldAlert,
                },
                {
                  title: "40%+ Conversation Delays",
                  desc: "Waiting for team members to compile, translate, and re-type replies.",
                  icon: XCircle,
                },
              ].map((item) => (
                <div
                  key={item.title}
                  className="bg-white/80 p-4 rounded-2xl border border-red-100/50 flex gap-4 items-start shadow-sm"
                >
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-slate-600 text-sm leading-relaxed font-semibold">
                Type naturally. Speak naturally. All messages convert instantly
                on-the-fly, keeping tone, velocity, and clarity intact.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  title: "Zero App-Switching Needed",
                  desc: "All incoming and outgoing texts translate automatically directly inside your chat threads.",
                  icon: CheckCircle,
                },
                {
                  title: "Nuanced Idiomatic Accuracy",
                  desc: "Our neural models read slang and professional syntax to preserve intended meaning.",
                  icon: CheckCircle,
                },
                {
                  title: "Milliseconds Delivery Speed",
                  desc: "Zero lag. Real-time translation sync matches standard communication speed.",
                  icon: Zap,
                },
              ].map((item) => (
                <div
                  key={item.title}
                  className="bg-white/80 p-4 rounded-2xl border border-brand-100/30 flex gap-4 items-start shadow-sm"
                >
