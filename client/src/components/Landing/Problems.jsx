  ...
  const problems = [
    {
      ...
      desc: "Collaborate dynamically with overseas clients and partners without delayed, manual translation chains.",
      icon: Building2,
      color: "text-blue-600 bg-blue-50 border-blue-100",
    },
    {
      title: "Global Customer Support",
      desc: "Solve support tickets and converse with global users instantly in their native language.",
      icon: Shield,
      color: "text-brand bg-brand-50 border-brand-100",
    },
    {
      title: "Remote Workforce",
      desc: "Keep distributed teams unified. Align priorities without leaving anyone out of translation loops.",
      icon: Users,
      color: "text-indigo-600 bg-indigo-50 border-indigo-100",
    },
    {
      title: "Friends Across Borders",
      desc: "Maintain meaningful global relationships without dealing with separate copy-paste translation tabs.",
      icon: Heart,
      color: "text-rose-600 bg-rose-50 border-rose-100",
    },
    {
      title: "Educational Academies",
      desc: "Host international lectures and classrooms where students from all nations participate naturally.",
      icon: GraduationCap,
      color: "text-emerald-600 bg-emerald-50 border-emerald-100",
    },
    {
      title: "Global Communities",
      desc: "Build highly engaged multilingual chat boards, department channels, and global associations.",
      icon: Globe,
