  ...
  const reviews = [
    {
      ...
      quote:
        "Biz-Translate has revolutionized our offshore support operations. Our US team connects seamlessly with Latin American contractors, translating complex technical specs instantly.",
    },
    {
      name: "Rohan Sharma",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-20">
          ...
          <p className="text-slate-500 font-medium text-base">
            See how international operations teams use Biz-Translate to maintain
            rapid velocity.
          </p>
        </div>
